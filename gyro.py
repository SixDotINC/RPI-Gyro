...
class MPU:
    ...
    def compFilter(self):
        ...
        if(round(self.roll,1) > 20): ser.write("F".encode())
        elif(round(self.roll,1) < -20): ser.write("B".encode())
        elif(round(self.pitch,1) > 20): ser.write("U".encode())
        elif(round(self.pitch,1) < -20): ser.write("D".encode())
        elif(round(self.yaw,1) > 20): ser.write("L".encode())
        elif(round(self.yaw,1) < -20): ser.write("R".encode())
        else: ser.write("0".encode())
